...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public Location getLocation() {
        return new Location(getWorld(), entity.posX, entity.posY, entity.posZ, entity.getBukkitYaw(), entity.rotationPitch); //TODO MD
    }
    ...
    public Location getLocation(Location loc) {
        if (loc != null) {
            ...
            loc.setYaw(entity.getBukkitYaw()); //TODO MD
    ...
    public World getWorld() {
        return entity.world.getWorld(); //TODO impl
    }
    ...
    public List<org.bukkit.entity.Entity> getNearbyEntities(double x, double y, double z) {
        ...
        for (Entity e : notchEntityList) {
            bukkitEntityList.add(e.getBukkitEntity()); //TODO impl
        }
    ...
    public boolean isValid() {
        return entity.isEntityAlive() && entity.valid; //TODO impl
    }
    ...
    public org.bukkit.entity.Entity getPassenger() {
        return isEmpty() ? null : getHandle().getPassengers().get(0).getBukkitEntity(); //TODO impl
    }
    ...
    public List<org.bukkit.entity.Entity> getPassengers() {
        return Lists.newArrayList(Lists.transform(getHandle().getPassengers(), new Function<Entity, org.bukkit.entity.Entity>() {
            ...
            public org.bukkit.entity.Entity apply(Entity input) {
                return input.getBukkitEntity(); //TODO impl
            }
        }));
    }
    ...
    public org.bukkit.entity.Entity getVehicle() {
        ...
        return getHandle().getRidingEntity().getBukkitEntity(); //TODO impl
    }
