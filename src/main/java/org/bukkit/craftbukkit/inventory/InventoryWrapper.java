...
public class InventoryWrapper implements IInventory {
    ...
    @Override
    public List<ItemStack> getContents() { //TODO impl
    ...
    @Override
    public void onOpen(CraftHumanEntity who) { //TODO impl
        viewers.add(who);
    }

    @Override
    public void onClose(CraftHumanEntity who) { //TODO impl
        viewers.remove(who);
    }

    @Override
    public List<HumanEntity> getViewers() { //TODO impl
        return viewers;
    }

    @Override
    public InventoryHolder getOwner() { //TODO impl
        return inventory.getHolder();
    }

    @Override
    public void setMaxStackSize(int size) { //TODO impl
    ...
    @Override
    public Location getLocation() { //TODO impl
